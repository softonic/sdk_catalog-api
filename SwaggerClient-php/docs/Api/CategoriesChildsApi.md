# Swagger\Client\CategoriesChildsApi
...
$api_instance = new Swagger\Client\Api\CategoriesChildsApi();
$id_category = "id_category_example"; // string | Parent category identifier
$body = new \Swagger\Client\Model\CategoryChild(); // \Swagger\Client\Model\CategoryChild | 
 ...
 **body** | [**\Swagger\Client\Model\CategoryChild**](../Model/\Swagger\Client\Model\CategoryChild.md)|  | [optional]
...
# **findCategoryChild**
> \Swagger\Client\Model\CategoryChild[] findCategoryChild($id_category)
...
[**\Swagger\Client\Model\CategoryChild[]**](../Model/CategoryChild.md)
...
# **readCategoryChild**
> \Swagger\Client\Model\CategoryChild readCategoryChild($id_category, $id_child)
