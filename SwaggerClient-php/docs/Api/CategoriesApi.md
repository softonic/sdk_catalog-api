...
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\Category**](../Model/\Swagger\Client\Model\Category.md)|  | [optional]
...
# **findCategory**
> \Swagger\Client\Model\Category[] findCategory()
...
# **readCategory**
> \Swagger\Client\Model\Category readCategory($id_category)
