...
class RequirementsApi
{
     ...
     * @return \Swagger\Client\Model\Requirement[]
     */
     ...
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return array of \Swagger\Client\Model\Requirement[], HTTP status code, HTTP response headers (array of strings)
     */
    public function findRequirementWithHttpInfo()
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\Requirement[]',
                '/requirements'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\Requirement[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\Requirement[]', $e->getResponseHeaders());
