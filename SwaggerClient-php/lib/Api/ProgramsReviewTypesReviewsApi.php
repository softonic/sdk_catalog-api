...
class ProgramsReviewTypesReviewsApi
{
     ...
     * @param \Swagger\Client\Model\ProgramReviewTypeReview $body  (optional)
     ...
     * @param string $id_review_type Review owner type (required)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return \Swagger\Client\Model\ProgramReviewTypeReview[]
     */
     ...
     * @param string $id_review_type Review owner type (required)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return array of \Swagger\Client\Model\ProgramReviewTypeReview[], HTTP status code, HTTP response headers (array of strings)
     */
    public function findProgramReviewTypeReviewWithHttpInfo($id_program, $id_review_type)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\ProgramReviewTypeReview[]',
                '/programs/{id_program}/review-types/{id_review_type}/reviews'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\ProgramReviewTypeReview[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\ProgramReviewTypeReview[]', $e->getResponseHeaders());
