...
class ProgramsReviewTypesReviewsImagesApi
{
     ...
     * @param \Swagger\Client\Model\ProgramReviewTypeReviewImage $body  (optional)
     ...
     * @param string $id_review Review identifier as UUID (required)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return \Swagger\Client\Model\ProgramReviewTypeReviewImage[]
     */
     ...
     * @param string $id_review Review identifier as UUID (required)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return array of \Swagger\Client\Model\ProgramReviewTypeReviewImage[], HTTP status code, HTTP response headers (array of strings)
     */
    public function findProgramReviewTypeReviewImageWithHttpInfo($id_program, $id_review_type, $id_review)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\ProgramReviewTypeReviewImage[]',
                '/programs/{id_program}/review-types/{id_review_type}/reviews/{id_review}/images'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\ProgramReviewTypeReviewImage[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\ProgramReviewTypeReviewImage[]', $e->getResponseHeaders());
