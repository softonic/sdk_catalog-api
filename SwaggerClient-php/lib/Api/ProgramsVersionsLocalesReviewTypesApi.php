...
class ProgramsVersionsLocalesReviewTypesApi
{
     ...
     * @param \Swagger\Client\Model\ProgramVersionLocaleReviewType $body  (optional)
     ...
     * @param string $id_locale Locale identifier (required)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return \Swagger\Client\Model\ProgramVersionLocaleReviewType[]
     */
     ...
     * @param string $id_locale Locale identifier (required)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return array of \Swagger\Client\Model\ProgramVersionLocaleReviewType[], HTTP status code, HTTP response headers (array of strings)
     */
    public function findProgramVersionLocaleReviewTypeWithHttpInfo($id_program, $id_version, $id_locale)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\ProgramVersionLocaleReviewType[]',
                '/programs/{id_program}/versions/{id_version}/locales/{id_locale}/review-types'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\ProgramVersionLocaleReviewType[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\ProgramVersionLocaleReviewType[]', $e->getResponseHeaders());
