...
class ProgramsApi
{
     ...
     *
     * @param \Swagger\Client\Model\Program $body  (optional)
    ...
    public function findProgramWithHttpInfo($page = null, $limit = null)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\Program[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\Program[]', $e->getResponseHeaders());
