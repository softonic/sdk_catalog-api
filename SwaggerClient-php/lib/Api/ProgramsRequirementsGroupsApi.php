...
class ProgramsRequirementsGroupsApi
{
     ...
     * @param \Swagger\Client\Model\ProgramRequirementGroup $body  (optional)
     ...
     * @param string $id_program Program UUID (required)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return \Swagger\Client\Model\ProgramRequirementGroup[]
     */
     ...
     * @param string $id_program Program UUID (required)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return array of \Swagger\Client\Model\ProgramRequirementGroup[], HTTP status code, HTTP response headers (array of strings)
     */
    public function findProgramRequirementGroupWithHttpInfo($id_program)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\ProgramRequirementGroup[]',
                '/programs/{id_program}/requirements-groups'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\ProgramRequirementGroup[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\ProgramRequirementGroup[]', $e->getResponseHeaders());
