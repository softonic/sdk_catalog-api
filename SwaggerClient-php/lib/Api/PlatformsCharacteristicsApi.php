...
class PlatformsCharacteristicsApi
{
     ...
     * @return \Swagger\Client\Model\PlatformCharacteristic[]
     */
     ...
     * @param string $id_platform Platform ID (required)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return array of \Swagger\Client\Model\PlatformCharacteristic[], HTTP status code, HTTP response headers (array of strings)
     */
    public function findPlatformCharacteristicWithHttpInfo($id_platform)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\PlatformCharacteristic[]',
                '/platforms/{id_platform}/characteristics'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\PlatformCharacteristic[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\PlatformCharacteristic[]', $e->getResponseHeaders());
