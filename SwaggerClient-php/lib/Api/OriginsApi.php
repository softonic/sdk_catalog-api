...
class OriginsApi
{
     ...
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return array of \Swagger\Client\Model\Origin[], HTTP status code, HTTP response headers (array of strings)
     */
    public function findOriginWithHttpInfo()
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\Origin[]',
                '/origins'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\Origin[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\Origin[]', $e->getResponseHeaders());
     ...
     *
     * @param string $id_origin Origin ID (required)
     * @param \Swagger\Client\Model\Origin $body  (optional)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return void
     */
