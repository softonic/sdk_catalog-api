...
class ProgramsVersionsPlatformCharacteristicsApi
{
     ...
     * @param \Swagger\Client\Model\ProgramVersionPlatformCharacteristic $body  (optional)
     ...
     * @param string $id_version Program version ID (required)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return \Swagger\Client\Model\ProgramVersionPlatformCharacteristic[]
     */
     ...
     * @param string $id_version Program version ID (required)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return array of \Swagger\Client\Model\ProgramVersionPlatformCharacteristic[], HTTP status code, HTTP response headers (array of strings)
     */
    public function findProgramVersionPlatformCharacteristicWithHttpInfo($id_program, $id_version)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\ProgramVersionPlatformCharacteristic[]',
                '/programs/{id_program}/versions/{id_version}/platform-characteristics'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\ProgramVersionPlatformCharacteristic[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\ProgramVersionPlatformCharacteristic[]', $e->getResponseHeaders());
