...
class ProgramsVersionsLocalesApi
{
     ...
     * @param \Swagger\Client\Model\ProgramVersionLocale $body  (optional)
     ...
     * @param string $id_version Program version identifier (required)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return \Swagger\Client\Model\ProgramVersionLocale[]
     */
     ...
     * @param string $id_version Program version identifier (required)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return array of \Swagger\Client\Model\ProgramVersionLocale[], HTTP status code, HTTP response headers (array of strings)
     */
    public function findProgramVersionLocaleWithHttpInfo($id_program, $id_version)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\ProgramVersionLocale[]',
                '/programs/{id_program}/versions/{id_version}/locales'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\ProgramVersionLocale[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\ProgramVersionLocale[]', $e->getResponseHeaders());
