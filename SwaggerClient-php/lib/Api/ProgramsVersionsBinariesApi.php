...
class ProgramsVersionsBinariesApi
{
     ...
     * @param \Swagger\Client\Model\ProgramVersionBinary $body  (optional)
     ...
     * @param string $id_version Version from program (required)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return \Swagger\Client\Model\ProgramVersionBinary[]
     */
     ...
     * @param string $id_version Version from program (required)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return array of \Swagger\Client\Model\ProgramVersionBinary[], HTTP status code, HTTP response headers (array of strings)
     */
    public function findProgramVersionBinaryWithHttpInfo($id_program, $id_version)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\ProgramVersionBinary[]',
                '/programs/{id_program}/versions/{id_version}/binaries'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\ProgramVersionBinary[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\ProgramVersionBinary[]', $e->getResponseHeaders());
