...
class ProgramsVersionsApi
{
    ...
    public function createProgramVersionWithHttpInfo($id_program, $body = null)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for "$id_program" when calling ProgramsVersionsApi.createProgramVersion, must be bigger than or equal to 1.');
        }
    ...
    public function deleteProgramVersionWithHttpInfo($id_program, $id_version)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for "$id_program" when calling ProgramsVersionsApi.deleteProgramVersion, must be bigger than or equal to 1.');
        }
    ...
    public function findProgramVersionWithHttpInfo($id_program)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for "$id_program" when calling ProgramsVersionsApi.findProgramVersion, must be bigger than or equal to 1.');
        }
    ...
    public function readProgramVersionWithHttpInfo($id_program, $id_version)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for "$id_program" when calling ProgramsVersionsApi.readProgramVersion, must be bigger than or equal to 1.');
        }
    ...
    public function replaceProgramVersionWithHttpInfo($id_program, $id_version, $body = null)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for "$id_program" when calling ProgramsVersionsApi.replaceProgramVersion, must be bigger than or equal to 1.');
        }
    ...
    public function updateProgramVersionWithHttpInfo($id_program, $id_version, $body = null)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for "$id_program" when calling ProgramsVersionsApi.updateProgramVersion, must be bigger than or equal to 1.');
        }
