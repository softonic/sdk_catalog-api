...
class ProgramsVersionsLocalesApi
{
     ...
     * @param \Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Model\ProgramVersionLocale $body  (optional)
     ...
     * @param string $id_version Program version identifier (required)
     * @throws \Softonic\CatalogApiSdk\ApiException on non-2xx response
     * @return \Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Model\ProgramVersionLocale[]
     */
     ...
     * @param string $id_version Program version identifier (required)
     * @throws \Softonic\CatalogApiSdk\ApiException on non-2xx response
     * @return array of \Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Model\ProgramVersionLocale[], HTTP status code, HTTP response headers (array of strings)
     */
    public function findProgramVersionLocaleWithHttpInfo($id_program, $id_version)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Model\ProgramVersionLocale[]',
                '/programs/{id_program}/versions/{id_version}/locales'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Model\ProgramVersionLocale[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Model\ProgramVersionLocale[]', $e->getResponseHeaders());
