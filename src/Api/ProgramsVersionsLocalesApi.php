...
class ProgramsVersionsLocalesApi
{
    ...
    public function createProgramVersionLocaleWithHttpInfo($id_program, $id_version, $body = null)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for "$id_program" when calling ProgramsVersionsLocalesApi.createProgramVersionLocale, must be bigger than or equal to 1.');
        }
    ...
    public function deleteProgramVersionLocaleWithHttpInfo($id_program, $id_version, $id_locale)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for "$id_program" when calling ProgramsVersionsLocalesApi.deleteProgramVersionLocale, must be bigger than or equal to 1.');
        }
    ...
    public function findProgramVersionLocaleWithHttpInfo($id_program, $id_version)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for "$id_program" when calling ProgramsVersionsLocalesApi.findProgramVersionLocale, must be bigger than or equal to 1.');
        }
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Softonic\CatalogApiSdk\Model\ProgramVersionLocale[]', $e->getResponseHeaders());
    ...
    public function readProgramVersionLocaleWithHttpInfo($id_program, $id_version, $id_locale)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for "$id_program" when calling ProgramsVersionsLocalesApi.readProgramVersionLocale, must be bigger than or equal to 1.');
        }
    ...
    public function replaceProgramVersionLocaleWithHttpInfo($id_program, $id_version, $id_locale, $body = null)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for "$id_program" when calling ProgramsVersionsLocalesApi.replaceProgramVersionLocale, must be bigger than or equal to 1.');
        }
    ...
    public function updateProgramVersionLocaleWithHttpInfo($id_program, $id_version, $id_locale, $body = null)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for "$id_program" when calling ProgramsVersionsLocalesApi.updateProgramVersionLocale, must be bigger than or equal to 1.');
        }
