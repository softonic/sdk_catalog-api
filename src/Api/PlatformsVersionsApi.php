...
class PlatformsVersionsApi
{
     ...
     * @return \Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Model\PlatformVersion[]
     */
     ...
     * @param string $id_platform Platform ID (required)
     * @throws \Softonic\CatalogApiSdk\ApiException on non-2xx response
     * @return array of \Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Model\PlatformVersion[], HTTP status code, HTTP response headers (array of strings)
     */
    public function findPlatformVersionWithHttpInfo($id_platform)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Model\PlatformVersion[]',
                '/platforms/{id_platform}/versions'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Model\PlatformVersion[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Model\PlatformVersion[]', $e->getResponseHeaders());
