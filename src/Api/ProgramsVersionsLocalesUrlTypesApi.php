...
class ProgramsVersionsLocalesUrlTypesApi
{
     ...
     * @param \Softonic\CatalogApiSdk\Model\ProgramVersionLocaleUrlType $body  (optional)
     *
     * @return void
    ...
    public function createProgramVersionLocaleUrlTypeWithHttpInfo($id_program, $id_version, $id_locale, $body = null)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for "$id_program" when calling ProgramsVersionsLocalesUrlTypesApi.createProgramVersionLocaleUrlType, must be bigger than or equal to 1.');
        }
    ...
    public function deleteProgramVersionLocaleUrlTypeWithHttpInfo($id_program, $id_version, $id_locale, $id_url_type)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for "$id_program" when calling ProgramsVersionsLocalesUrlTypesApi.deleteProgramVersionLocaleUrlType, must be bigger than or equal to 1.');
        }
     ...
     * @param string $id_locale Locale identifier (required)
     *
     * @return \Softonic\CatalogApiSdk\Model\ProgramVersionLocaleUrlType[]
     * @throws \Softonic\CatalogApiSdk\ApiException on non-2xx response
     */
     ...
     * @param string $id_locale Locale identifier (required)
     *
     * @return Array of \Softonic\CatalogApiSdk\Model\ProgramVersionLocaleUrlType[], HTTP status code, HTTP response headers (array of strings)
     * @throws \Softonic\CatalogApiSdk\ApiException on non-2xx response
     */
    public function findProgramVersionLocaleUrlTypeWithHttpInfo($id_program, $id_version, $id_locale)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for "$id_program" when calling ProgramsVersionsLocalesUrlTypesApi.findProgramVersionLocaleUrlType, must be bigger than or equal to 1.');
        }
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Softonic\CatalogApiSdk\Model\ProgramVersionLocaleUrlType[]'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Softonic\CatalogApiSdk\Model\ProgramVersionLocaleUrlType[]', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Softonic\CatalogApiSdk\Model\ProgramVersionLocaleUrlType[]', $e->getResponseHeaders());
    ...
    public function readProgramVersionLocaleUrlTypeWithHttpInfo($id_program, $id_version, $id_locale, $id_url_type)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for "$id_program" when calling ProgramsVersionsLocalesUrlTypesApi.readProgramVersionLocaleUrlType, must be bigger than or equal to 1.');
        }
    ...
    public function replaceProgramVersionLocaleUrlTypeWithHttpInfo($id_program, $id_version, $id_locale, $id_url_type, $body = null)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for "$id_program" when calling ProgramsVersionsLocalesUrlTypesApi.replaceProgramVersionLocaleUrlType, must be bigger than or equal to 1.');
        }
    ...
    public function updateProgramVersionLocaleUrlTypeWithHttpInfo($id_program, $id_version, $id_locale, $id_url_type, $body = null)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for "$id_program" when calling ProgramsVersionsLocalesUrlTypesApi.updateProgramVersionLocaleUrlType, must be bigger than or equal to 1.');
        }
