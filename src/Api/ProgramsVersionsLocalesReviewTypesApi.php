...
class ProgramsVersionsLocalesReviewTypesApi
{
     ...
     * @param \Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Model\ProgramVersionLocaleReviewType $body  (optional)
     ...
     * @param string $id_locale Locale identifier (required)
     * @throws \Softonic\CatalogApiSdk\ApiException on non-2xx response
     * @return \Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Model\ProgramVersionLocaleReviewType[]
     */
     ...
     * @param string $id_locale Locale identifier (required)
     * @throws \Softonic\CatalogApiSdk\ApiException on non-2xx response
     * @return array of \Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Model\ProgramVersionLocaleReviewType[], HTTP status code, HTTP response headers (array of strings)
     */
    public function findProgramVersionLocaleReviewTypeWithHttpInfo($id_program, $id_version, $id_locale)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Model\ProgramVersionLocaleReviewType[]',
                '/programs/{id_program}/versions/{id_version}/locales/{id_locale}/review-types'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Model\ProgramVersionLocaleReviewType[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Model\ProgramVersionLocaleReviewType[]', $e->getResponseHeaders());
