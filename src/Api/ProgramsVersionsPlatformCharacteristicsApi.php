...
class ProgramsVersionsPlatformCharacteristicsApi
{
    ...
    public function createProgramVersionPlatformCharacteristicWithHttpInfo($id_program, $id_version, $body = null)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for "$id_program" when calling ProgramsVersionsPlatformCharacteristicsApi.createProgramVersionPlatformCharacteristic, must be bigger than or equal to 1.');
        }
    ...
    public function deleteProgramVersionPlatformCharacteristicWithHttpInfo($id_program, $id_version, $id_platform_characteristic)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for "$id_program" when calling ProgramsVersionsPlatformCharacteristicsApi.deleteProgramVersionPlatformCharacteristic, must be bigger than or equal to 1.');
        }
    ...
    public function findProgramVersionPlatformCharacteristicWithHttpInfo($id_program, $id_version)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for "$id_program" when calling ProgramsVersionsPlatformCharacteristicsApi.findProgramVersionPlatformCharacteristic, must be bigger than or equal to 1.');
        }
    ...
    public function readProgramVersionPlatformCharacteristicWithHttpInfo($id_program, $id_version, $id_platform_characteristic)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for "$id_program" when calling ProgramsVersionsPlatformCharacteristicsApi.readProgramVersionPlatformCharacteristic, must be bigger than or equal to 1.');
        }
