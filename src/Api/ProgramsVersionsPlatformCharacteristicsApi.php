...
class ProgramsVersionsPlatformCharacteristicsApi
{
     ...
     * @param \Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Model\ProgramVersionPlatformCharacteristic $body  (optional)
     ...
     * @param string $id_version Program version ID (required)
     * @throws \Softonic\CatalogApiSdk\ApiException on non-2xx response
     * @return \Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Model\ProgramVersionPlatformCharacteristic[]
     */
     ...
     * @param string $id_version Program version ID (required)
     * @throws \Softonic\CatalogApiSdk\ApiException on non-2xx response
     * @return array of \Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Model\ProgramVersionPlatformCharacteristic[], HTTP status code, HTTP response headers (array of strings)
     */
    public function findProgramVersionPlatformCharacteristicWithHttpInfo($id_program, $id_version)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Model\ProgramVersionPlatformCharacteristic[]',
                '/programs/{id_program}/versions/{id_version}/platform-characteristics'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Model\ProgramVersionPlatformCharacteristic[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Model\ProgramVersionPlatformCharacteristic[]', $e->getResponseHeaders());
