...
class ProgramsUrlTypesApi
{
    ...
    public function findProgramUrlTypeWithHttpInfo($id_program)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for "$id_program" when calling ProgramsUrlTypesApi.findProgramUrlType, must be bigger than or equal to 1.');
        }
