...
class ProgramsReviewTypesApi
{
     ...
     * @return \Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Model\ProgramReviewType[]
     */
     ...
     * @param string $id_program Program UUID (required)
     * @throws \Softonic\CatalogApiSdk\ApiException on non-2xx response
     * @return array of \Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Model\ProgramReviewType[], HTTP status code, HTTP response headers (array of strings)
     */
    public function findProgramReviewTypeWithHttpInfo($id_program)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Model\ProgramReviewType[]',
                '/programs/{id_program}/review-types'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Model\ProgramReviewType[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Model\ProgramReviewType[]', $e->getResponseHeaders());
