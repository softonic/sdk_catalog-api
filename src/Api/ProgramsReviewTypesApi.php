...
class ProgramsReviewTypesApi
{
    ...
    public function findProgramReviewTypeWithHttpInfo($id_program)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for "$id_program" when calling ProgramsReviewTypesApi.findProgramReviewType, must be bigger than or equal to 1.');
        }
