...
class ProgramsReviewTypesReviewsImagesApi
{
     ...
     * @param \Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Model\ProgramReviewTypeReviewImage $body  (optional)
     ...
     * @param string $id_review Review identifier as UUID (required)
     * @throws \Softonic\CatalogApiSdk\ApiException on non-2xx response
     * @return \Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Model\ProgramReviewTypeReviewImage[]
     */
     ...
     * @param string $id_review Review identifier as UUID (required)
     * @throws \Softonic\CatalogApiSdk\ApiException on non-2xx response
     * @return array of \Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Model\ProgramReviewTypeReviewImage[], HTTP status code, HTTP response headers (array of strings)
     */
    public function findProgramReviewTypeReviewImageWithHttpInfo($id_program, $id_review_type, $id_review)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Model\ProgramReviewTypeReviewImage[]',
                '/programs/{id_program}/review-types/{id_review_type}/reviews/{id_review}/images'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Model\ProgramReviewTypeReviewImage[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Model\ProgramReviewTypeReviewImage[]', $e->getResponseHeaders());
