...
class ProgramsReviewTypesReviewsImagesApi
{
     ...
     * @param \Softonic\CatalogApiSdk\Model\ProgramReviewTypeReviewImage $body  (optional)
     *
     * @return void
    ...
    public function createProgramReviewTypeReviewImageWithHttpInfo($id_program, $id_review_type, $id_review, $body = null)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for "$id_program" when calling ProgramsReviewTypesReviewsImagesApi.createProgramReviewTypeReviewImage, must be bigger than or equal to 1.');
        }
    ...
    public function deleteProgramReviewTypeReviewImageWithHttpInfo($id_program, $id_review_type, $id_review, $id_image)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for "$id_program" when calling ProgramsReviewTypesReviewsImagesApi.deleteProgramReviewTypeReviewImage, must be bigger than or equal to 1.');
        }
     ...
     * @param string $id_review Review identifier as UUID (required)
     *
     * @return \Softonic\CatalogApiSdk\Model\ProgramReviewTypeReviewImage[]
     * @throws \Softonic\CatalogApiSdk\ApiException on non-2xx response
     */
     ...
     * @param string $id_review Review identifier as UUID (required)
     *
     * @return Array of \Softonic\CatalogApiSdk\Model\ProgramReviewTypeReviewImage[], HTTP status code, HTTP response headers (array of strings)
     * @throws \Softonic\CatalogApiSdk\ApiException on non-2xx response
     */
    public function findProgramReviewTypeReviewImageWithHttpInfo($id_program, $id_review_type, $id_review)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for "$id_program" when calling ProgramsReviewTypesReviewsImagesApi.findProgramReviewTypeReviewImage, must be bigger than or equal to 1.');
        }
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Softonic\CatalogApiSdk\Model\ProgramReviewTypeReviewImage[]'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Softonic\CatalogApiSdk\Model\ProgramReviewTypeReviewImage[]', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Softonic\CatalogApiSdk\Model\ProgramReviewTypeReviewImage[]', $e->getResponseHeaders());
    ...
    public function readProgramReviewTypeReviewImageWithHttpInfo($id_program, $id_review_type, $id_review, $id_image)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for "$id_program" when calling ProgramsReviewTypesReviewsImagesApi.readProgramReviewTypeReviewImage, must be bigger than or equal to 1.');
        }
    ...
    public function replaceProgramReviewTypeReviewImageWithHttpInfo($id_program, $id_review_type, $id_review, $id_image, $body = null)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for "$id_program" when calling ProgramsReviewTypesReviewsImagesApi.replaceProgramReviewTypeReviewImage, must be bigger than or equal to 1.');
        }
    ...
    public function updateProgramReviewTypeReviewImageWithHttpInfo($id_program, $id_review_type, $id_review, $id_image, $body = null)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for "$id_program" when calling ProgramsReviewTypesReviewsImagesApi.updateProgramReviewTypeReviewImage, must be bigger than or equal to 1.');
        }
