...
class ProgramsVersionsBinariesApi
{
    ...
    public function createProgramVersionBinaryWithHttpInfo($id_program, $id_version, $body = null)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for "$id_program" when calling ProgramsVersionsBinariesApi.createProgramVersionBinary, must be bigger than or equal to 1.');
        }
    ...
    public function deleteProgramVersionBinaryWithHttpInfo($id_program, $id_version, $id_binary)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for "$id_program" when calling ProgramsVersionsBinariesApi.deleteProgramVersionBinary, must be bigger than or equal to 1.');
        }
    ...
    public function findProgramVersionBinaryWithHttpInfo($id_program, $id_version)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for "$id_program" when calling ProgramsVersionsBinariesApi.findProgramVersionBinary, must be bigger than or equal to 1.');
        }
    ...
    public function readProgramVersionBinaryWithHttpInfo($id_program, $id_version, $id_binary)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for "$id_program" when calling ProgramsVersionsBinariesApi.readProgramVersionBinary, must be bigger than or equal to 1.');
        }
    ...
    public function replaceProgramVersionBinaryWithHttpInfo($id_program, $id_version, $id_binary, $body = null)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for "$id_program" when calling ProgramsVersionsBinariesApi.replaceProgramVersionBinary, must be bigger than or equal to 1.');
        }
    ...
    public function updateProgramVersionBinaryWithHttpInfo($id_program, $id_version, $id_binary, $body = null)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for "$id_program" when calling ProgramsVersionsBinariesApi.updateProgramVersionBinary, must be bigger than or equal to 1.');
        }
