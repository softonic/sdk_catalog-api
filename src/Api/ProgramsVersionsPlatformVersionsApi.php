...
class ProgramsVersionsPlatformVersionsApi
{
     ...
     * @param \Softonic\CatalogApiSdk\Model\ProgramVersionPlatformVersion $body  (optional)
     *
     * @return void
    ...
    public function createProgramVersionPlatformVersionWithHttpInfo($id_program, $id_version, $body = null)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for "$id_program" when calling ProgramsVersionsPlatformVersionsApi.createProgramVersionPlatformVersion, must be bigger than or equal to 1.');
        }
    ...
    public function deleteProgramVersionPlatformVersionWithHttpInfo($id_program, $id_version, $id_platform_version)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for "$id_program" when calling ProgramsVersionsPlatformVersionsApi.deleteProgramVersionPlatformVersion, must be bigger than or equal to 1.');
        }
     ...
     * @param string $id_version Program version ID (required)
     *
     * @return \Softonic\CatalogApiSdk\Model\ProgramVersionPlatformVersion[]
     * @throws \Softonic\CatalogApiSdk\ApiException on non-2xx response
     */
     ...
     * @param string $id_version Program version ID (required)
     *
     * @return Array of \Softonic\CatalogApiSdk\Model\ProgramVersionPlatformVersion[], HTTP status code, HTTP response headers (array of strings)
     * @throws \Softonic\CatalogApiSdk\ApiException on non-2xx response
     */
    public function findProgramVersionPlatformVersionWithHttpInfo($id_program, $id_version)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for "$id_program" when calling ProgramsVersionsPlatformVersionsApi.findProgramVersionPlatformVersion, must be bigger than or equal to 1.');
        }
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Softonic\CatalogApiSdk\Model\ProgramVersionPlatformVersion[]'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Softonic\CatalogApiSdk\Model\ProgramVersionPlatformVersion[]', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Softonic\CatalogApiSdk\Model\ProgramVersionPlatformVersion[]', $e->getResponseHeaders());
    ...
    public function readProgramVersionPlatformVersionWithHttpInfo($id_program, $id_version, $id_platform_version)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for "$id_program" when calling ProgramsVersionsPlatformVersionsApi.readProgramVersionPlatformVersion, must be bigger than or equal to 1.');
        }
    ...
    public function replaceProgramVersionPlatformVersionWithHttpInfo($id_program, $id_version, $id_platform_version)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for "$id_program" when calling ProgramsVersionsPlatformVersionsApi.replaceProgramVersionPlatformVersion, must be bigger than or equal to 1.');
        }
