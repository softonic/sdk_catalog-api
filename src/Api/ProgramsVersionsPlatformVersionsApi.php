...
class ProgramsVersionsPlatformVersionsApi
{
    ...
    /**
     * Operation updateProgramVersionPlatformVersion
     *
     ...
     * @throws \Softonic\CatalogApiSdk\ApiException on non-2xx response
     */
    public function updateProgramVersionPlatformVersion($id_program, $id_version, $id_platform_version)
    {
        list($response) = $this->updateProgramVersionPlatformVersionWithHttpInfo($id_program, $id_version, $id_platform_version);
        return $response;
    }


    /**
     * Operation updateProgramVersionPlatformVersionWithHttpInfo
     *
     * Partially updates a ProgramVersionPlatformVersion.
     *
     * @param string $id_program Program UUID (required)
     ...
     * @throws \Softonic\CatalogApiSdk\ApiException on non-2xx response
     */
    public function updateProgramVersionPlatformVersionWithHttpInfo($id_program, $id_version, $id_platform_version)
    {
        
        // verify the required parameter 'id_program' is set
        if ($id_program === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id_program when calling updateProgramVersionPlatformVersion');
        }

        // verify the required parameter 'id_version' is set
        if ($id_version === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id_version when calling updateProgramVersionPlatformVersion');
        }

        // verify the required parameter 'id_platform_version' is set
        if ($id_platform_version === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id_platform_version when calling updateProgramVersionPlatformVersion');
        }
