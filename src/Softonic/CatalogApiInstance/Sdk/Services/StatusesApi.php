...
class StatusesApi
{
     ...
     * @return mixed
     */
    public function read($id_statuses)
    {

        //parse inputs
        $resource_path = "/statuses/{id_statuses}";
        ...
        if($id_statuses != null) {
             $resource_path = str_replace("{" . "id_statuses" . "}",
                $this->api_client->toPathValue($id_statuses), $resource_path);
        }
        if (!isset($data)) {
            $data = array();
        }
