...
class LicensesApi
{
     ...
     *
     * @param integer $id_licenses License identifier
     *
     * @return mixed
     */
    public function read($id_licenses)
    {

        //parse inputs
        $resource_path = "/licenses/{id_licenses}";
        ...
        if($id_licenses != null) {
             $resource_path = str_replace("{" . "id_licenses" . "}",
                $this->api_client->toPathValue($id_licenses), $resource_path);
        }
        if (!isset($data)) {
            $data = array();
        }
