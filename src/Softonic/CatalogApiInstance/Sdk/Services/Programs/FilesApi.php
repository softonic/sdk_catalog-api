...
class FilesApi
{
     ...
     * @param string $id_files File identifier
     *
     * @return mixed
     */
    public function read($id_programs, $id_files)
    {

        //parse inputs
        $resource_path = "/programs/{id_programs}/files/{id_files}";
    ...
    public function find($id_programs)
    {
        ...
        //parse inputs
        $resource_path = "/programs/{id_programs}/files";
        $resource_path = str_replace("{format}", "json", $resource_path);
        $method = "GET";
