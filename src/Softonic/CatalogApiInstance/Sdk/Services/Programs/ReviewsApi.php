...
class ReviewsApi
{
     ...
     * @param integer $id_reviews Review identifier
     *
     * @return mixed
     */
    public function read($id_programs, $id_reviews)
    {

        //parse inputs
        $resource_path = "/programs/{id_programs}/reviews/{id_reviews}";
        ...
        if($id_reviews != null) {
             $resource_path = str_replace("{" . "id_reviews" . "}",
                $this->api_client->toPathValue($id_reviews), $resource_path);
        }
        if (!isset($data)) {
            $data = array();
        }
    ...
    public function find($id_programs)
    {
        ...
        //parse inputs
        $resource_path = "/programs/{id_programs}/reviews";
        $resource_path = str_replace("{format}", "json", $resource_path);
        $method = "GET";
