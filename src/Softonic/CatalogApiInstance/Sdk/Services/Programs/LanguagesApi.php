...
class LanguagesApi
{
     ...
     *
     * @param integer $id_programs Identifier of program
     * @param string $id_languages Identifier of language
     *
     * @return mixed
     */
    public function read($id_programs, $id_languages)
    {

        //parse inputs
        $resource_path = "/programs/{id_programs}/languages/{id_languages}";
        ...
        if($id_languages != null) {
             $resource_path = str_replace("{" . "id_languages" . "}",
                $this->api_client->toPathValue($id_languages), $resource_path);
        }
        if (!isset($data)) {
            $data = array();
        }
    ...
    public function find($id_programs)
    {
        ...
        //parse inputs
        $resource_path = "/programs/{id_programs}/languages";
        $resource_path = str_replace("{format}", "json", $resource_path);
        $method = "GET";
