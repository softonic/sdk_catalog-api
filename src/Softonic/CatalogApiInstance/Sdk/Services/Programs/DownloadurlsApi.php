...
class DownloadurlsApi
{
     ...
     * @param integer $id_downloadurls Program download url identifier
     *
     * @return mixed
     */
    public function read($id_programs, $id_downloadurls)
    {

        //parse inputs
        $resource_path = "/programs/{id_programs}/downloadurls/{id_downloadurls}";
        ...
        if($id_downloadurls != null) {
             $resource_path = str_replace("{" . "id_downloadurls" . "}",
                $this->api_client->toPathValue($id_downloadurls), $resource_path);
        }
        if (!isset($data)) {
            $data = array();
        }
    ...
    public function find($id_programs)
    {
        ...
        //parse inputs
        $resource_path = "/programs/{id_programs}/downloadurls";
        $resource_path = str_replace("{format}", "json", $resource_path);
        $method = "GET";
