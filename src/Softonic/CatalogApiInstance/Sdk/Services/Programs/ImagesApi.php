...
class ImagesApi
{
     ...
     * @param string $id_images Image identifier
     *
     * @return mixed
     */
    public function read($id_programs, $id_images)
    {

        //parse inputs
        $resource_path = "/programs/{id_programs}/images/{id_images}";
        ...
        if($id_images != null) {
             $resource_path = str_replace("{" . "id_images" . "}",
                $this->api_client->toPathValue($id_images), $resource_path);
        }
        if (!isset($data)) {
            $data = array();
        }
    ...
    public function find($id_programs)
    {
        ...
        //parse inputs
        $resource_path = "/programs/{id_programs}/images";
        $resource_path = str_replace("{format}", "json", $resource_path);
        $method = "GET";
