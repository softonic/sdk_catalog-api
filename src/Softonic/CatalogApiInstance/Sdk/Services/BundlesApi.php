...
class BundlesApi
{
     ...
     *
     * @param integer $id_bundles Bundle identifier
     *
     * @return mixed
     */
    public function read($id_bundles)
    {

        //parse inputs
        $resource_path = "/bundles/{id_bundles}";
        ...
        if($id_bundles != null) {
             $resource_path = str_replace("{" . "id_bundles" . "}",
                $this->api_client->toPathValue($id_bundles), $resource_path);
        }
        if (!isset($data)) {
            $data = array();
        }
