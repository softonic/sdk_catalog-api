...
class ReviewersApi
{
     ...
     *
     * @param integer $id_reviewers Reviewer identifier
     *
     * @return mixed
     */
    public function read($id_reviewers)
    {

        //parse inputs
        $resource_path = "/reviewers/{id_reviewers}";
        ...
        if($id_reviewers != null) {
             $resource_path = str_replace("{" . "id_reviewers" . "}",
                $this->api_client->toPathValue($id_reviewers), $resource_path);
        }
        if (!isset($data)) {
            $data = array();
        }
