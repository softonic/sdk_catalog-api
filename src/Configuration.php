...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'http://v2.catalog.priv.sftapi.com.sft-staging.com';
     ...
     * @var string
     */
    protected $userAgent = "Swagger-Codegen/2.0.17/php";
    ...
    public static function toDebugReport()
    {
        ...
        $report .= "    OpenAPI Spec Version: 2.0.17-83".PHP_EOL;
