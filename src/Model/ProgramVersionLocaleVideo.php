...
/**
 * ProgramVersionLocaleVideo Class Doc Comment
 *
 * @category    Class
 * @package     Softonic\CatalogApiSdk
 * @author      http://github.com/swagger-api/swagger-codegen
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ProgramVersionLocaleVideo implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'ProgramVersionLocaleVideo';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['id_video'] === null) {
            $invalid_properties[] = "'id_video' can't be null";
        }
    ...
    /**
     * Sets id_version
     * @param string $id_version Version identifier
     * @return $this
     */
    ...
    /**
     * Sets id_video
     * @param string $id_video Video Identifier
     * @return $this
     */
