...
class ProgramRequirementGroupRequirement implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (strlen($this->container['value']) > 40) {
            $invalid_properties[] = "invalid value for 'value', the character length must be smaller than or equal to 40.";
        }
    ...
    public function setIdProgram($id_program)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for $id_program when calling ProgramRequirementGroupRequirement., must be bigger than or equal to 1.');
        }
    ...
    {
        if (strlen($value) > 40) {
            throw new \InvalidArgumentException('invalid length for $value when calling ProgramRequirementGroupRequirement., must be smaller than or equal to 40.');
        }
        if (strlen($value) < 1) {
