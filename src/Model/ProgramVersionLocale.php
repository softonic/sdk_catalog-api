...
class ProgramVersionLocale implements ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['program_alias'] = isset($data['program_alias']) ? $data['program_alias'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = array("online", "hidden", "in progress", "blacklisted", "not listed");
    ...
    public function setIdProgram($id_program)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for $id_program when calling ProgramVersionLocale., must be bigger than or equal to 1.');
        }
     ...
     * @return string
     */
    public function getProgramAlias()
    {
        return $this->container['program_alias'];
    }

    /**
     * Sets program_alias
     * @param string $program_alias Program alias compatible with the URI RFC standard.
     * @return $this
     */
    public function setProgramAlias($program_alias)
    {
        if (strlen($program_alias) > 60) {
            throw new \InvalidArgumentException('invalid length for $program_alias when calling ProgramVersionLocale., must be smaller than or equal to 60.');
        }
        if (strlen($program_alias) < 1) {
            throw new \InvalidArgumentException('invalid length for $program_alias when calling ProgramVersionLocale., must be bigger than or equal to 1.');
        }
        $this->container['program_alias'] = $program_alias;
    ...
    public function setStatus($status)
    {
        ...
        if (!in_array($status, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'status', must be one of 'online', 'hidden', 'in progress', 'blacklisted', 'not listed'");
        }
    ...
    public function setIdEditor($id_editor)
    {
        ...
        if ($id_editor < 1.0) {
            throw new \InvalidArgumentException('invalid value for $id_editor when calling ProgramVersionLocale., must be bigger than or equal to 1.0.');
        }
