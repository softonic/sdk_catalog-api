...
class Program implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (strlen($this->container['id_developer']) > 40) {
            $invalid_properties[] = "invalid value for 'id_developer', the character length must be smaller than or equal to 40.";
        }
        ...
        if (strlen($this->container['id_platform']) > 40) {
            $invalid_properties[] = "invalid value for 'id_platform', the character length must be smaller than or equal to 40.";
        }
    ...
    {
        if (strlen($id_developer) > 40) {
            throw new \InvalidArgumentException('invalid length for $id_developer when calling Program., must be smaller than or equal to 40.');
        }
    ...
    {
        if (strlen($id_platform) > 40) {
            throw new \InvalidArgumentException('invalid length for $id_platform when calling Program., must be smaller than or equal to 40.');
        }
