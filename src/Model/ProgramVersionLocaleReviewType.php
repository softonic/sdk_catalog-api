...
class ProgramVersionLocaleReviewType implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (strlen($this->container['id_version']) > 185) {
            $invalid_properties[] = "invalid value for 'id_version', the character length must be smaller than or equal to 185.";
        }
    ...
    public function setIdProgram($id_program)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for $id_program when calling ProgramVersionLocaleReviewType., must be bigger than or equal to 1.');
        }
    ...
    public function setIdVersion($id_version)
    {
        if (strlen($id_version) > 185) {
            throw new \InvalidArgumentException('invalid length for $id_version when calling ProgramVersionLocaleReviewType., must be smaller than or equal to 185.');
        }
    ...
    /**
     * Sets id_locale
     * @param string $id_locale Locales id
     * @return $this
     */
