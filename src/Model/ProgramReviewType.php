...
class ProgramReviewType implements ArrayAccess
{
    ...
    const ID_REVIEW_TYPE_AUTO = 'auto';
    const ID_REVIEW_TYPE_SEMIAUTO = 'semiauto';
    const ID_REVIEW_TYPE_STANDARD = 'standard';
    const ID_REVIEW_TYPE_TOP = 'top';
    const ID_REVIEW_TYPE_UNDETERMINED = 'undetermined';
    const ID_REVIEW_TYPE_FASTCLONED = 'fastcloned';
    const ID_REVIEW_TYPE_NOREVIEW = 'noreview';
    const ID_REVIEW_TYPE_PREVIEW = 'preview';
    const ID_REVIEW_TYPE_CORE = 'core';
    ...
    {
        return [
            self::ID_REVIEW_TYPE_AUTO,
            self::ID_REVIEW_TYPE_SEMIAUTO,
            self::ID_REVIEW_TYPE_STANDARD,
            self::ID_REVIEW_TYPE_TOP,
            self::ID_REVIEW_TYPE_UNDETERMINED,
            self::ID_REVIEW_TYPE_FASTCLONED,
            self::ID_REVIEW_TYPE_NOREVIEW,
            self::ID_REVIEW_TYPE_PREVIEW,
            self::ID_REVIEW_TYPE_CORE,
        ];
    }
    ...
    public function setIdProgram($id_program)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for $id_program when calling ProgramReviewType., must be bigger than or equal to 1.');
        }
    ...
    public function setIdReviewType($id_review_type)
    {
        ...
        if (!in_array($id_review_type, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'id_review_type', must be one of 'auto', 'semiauto', 'standard', 'top', 'undetermined', 'fastcloned', 'noreview', 'preview', 'core'");
        }
