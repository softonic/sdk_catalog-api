...
class ProgramReviewTypeReview implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['rating'] > 10.0) {
            $invalid_properties[] = "invalid value for 'rating', must be smaller than or equal to 10.0.";
        }
        ...
        if (strlen($this->container['subfeatures']) > 150) {
            $invalid_properties[] = "invalid value for 'subfeatures', the character length must be smaller than or equal to 150.";
        }
        ...
        if (strlen($this->container['subusability']) > 150) {
            $invalid_properties[] = "invalid value for 'subusability', the character length must be smaller than or equal to 150.";
        }
        ...
        if (strlen($this->container['subconclusion']) > 150) {
            $invalid_properties[] = "invalid value for 'subconclusion', the character length must be smaller than or equal to 150.";
        }
    ...
    public function setRating($rating)
    {
        ...
        if ($rating > 10.0) {
            throw new \InvalidArgumentException('invalid value for $rating when calling ProgramReviewTypeReview., must be smaller than or equal to 10.0.');
        }
        if ($rating < 0.0) {
            throw new \InvalidArgumentException('invalid value for $rating when calling ProgramReviewTypeReview., must be bigger than or equal to 0.0.');
        }
    ...
    {
        if (strlen($subfeatures) > 150) {
            throw new \InvalidArgumentException('invalid length for $subfeatures when calling ProgramReviewTypeReview., must be smaller than or equal to 150.');
        }
    ...
    {
        if (strlen($subusability) > 150) {
            throw new \InvalidArgumentException('invalid length for $subusability when calling ProgramReviewTypeReview., must be smaller than or equal to 150.');
        }
    ...
    {
        if (strlen($subconclusion) > 150) {
            throw new \InvalidArgumentException('invalid length for $subconclusion when calling ProgramReviewTypeReview., must be smaller than or equal to 150.');
        }
