...
class ProgramVersionBinary implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (strlen($this->container['id_compliance_scans']) > 36) {
            $invalid_properties[] = "invalid value for 'id_compliance_scans', the character length must be smaller than or equal to 36.";
        }
        if (strlen($this->container['id_compliance_scans']) < 36) {
            $invalid_properties[] = "invalid value for 'id_compliance_scans', the character length must be bigger than or equal to 36.";
        }
        $allowed_values = array("pending", "clean", "warning", "blocked");
    ...
    {
        if (strlen($id_compliance_scans) > 36) {
            throw new \InvalidArgumentException('invalid length for $id_compliance_scans when calling ProgramVersionBinary., must be smaller than or equal to 36.');
        }
        if (strlen($id_compliance_scans) < 36) {
            throw new \InvalidArgumentException('invalid length for $id_compliance_scans when calling ProgramVersionBinary., must be bigger than or equal to 36.');
        }
    ...
    /**
     * Sets status
     * @param string $status File status. It can be clean, warning or blocked.
     * @return $this
     */
    public function setStatus($status)
    {
        ...
        if (!in_array($status, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'status', must be one of 'pending', 'clean', 'warning', 'blocked'");
        }
