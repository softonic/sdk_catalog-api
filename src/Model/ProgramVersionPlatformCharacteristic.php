...
class ProgramVersionPlatformCharacteristic implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (strlen($this->container['id_platform_characteristic']) > 0) {
            $invalid_properties[] = "invalid value for 'id_platform_characteristic', the character length must be smaller than or equal to 0.";
        }
        if (strlen($this->container['id_platform_characteristic']) < 0) {
            $invalid_properties[] = "invalid value for 'id_platform_characteristic', the character length must be bigger than or equal to 0.";
        }
    ...
    public function setIdProgram($id_program)
    {
        ...
        if (strlen($id_program) < 1) {
            throw new \InvalidArgumentException('invalid length for $id_program when calling ProgramVersionPlatformCharacteristic., must be bigger than or equal to 1.');
        }
    ...
    public function setIdVersion($id_version)
    {
        if (strlen($id_version) > 0) {
            throw new \InvalidArgumentException('invalid length for $id_version when calling ProgramVersionPlatformCharacteristic., must be smaller than or equal to 0.');
        }
        if (strlen($id_version) < 0) {
            throw new \InvalidArgumentException('invalid length for $id_version when calling ProgramVersionPlatformCharacteristic., must be bigger than or equal to 0.');
        }
    ...
    {
        if (strlen($id_platform_characteristic) > 0) {
            throw new \InvalidArgumentException('invalid length for $id_platform_characteristic when calling ProgramVersionPlatformCharacteristic., must be smaller than or equal to 0.');
        }
        if (strlen($id_platform_characteristic) < 0) {
            throw new \InvalidArgumentException('invalid length for $id_platform_characteristic when calling ProgramVersionPlatformCharacteristic., must be bigger than or equal to 0.');
        }
