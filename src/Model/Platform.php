...
class Platform implements ArrayAccess
{
    ...
    public function setIdPlatform($id_platform)
    {
        if (strlen($id_platform) > 0) {
            throw new \InvalidArgumentException('invalid length for $id_platform when calling Platform., must be smaller than or equal to 0.');
        }
        if (strlen($id_platform) < 0) {
            throw new \InvalidArgumentException('invalid length for $id_platform when calling Platform., must be bigger than or equal to 0.');
        }
    ...
    {
        if (strlen($name) > 0) {
            throw new \InvalidArgumentException('invalid length for $name when calling Platform., must be smaller than or equal to 0.');
        }
        if (strlen($name) < 0) {
            throw new \InvalidArgumentException('invalid length for $name when calling Platform., must be bigger than or equal to 0.');
        }
