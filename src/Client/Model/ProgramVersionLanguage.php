 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProgramVersionLanguage implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    public function __construct(array $data = [])
    {
        ...
        if (array_key_exists('id_language', $data)) $this->container['id_language'] = $data['id_language'];
    }
    ...
    {
        $allowedValues = $this->getIdLanguageAllowableValues();
        if (!in_array($id_language, $allowedValues)) {
