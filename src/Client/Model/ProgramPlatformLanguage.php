...
self::STATUS_NOT_LISTED,        ];
    ...
    public function __construct(array $data = [])
    {
        ...
        array_key_exists('publish_date', $data) && $this->container['publish_date'] = $data['publish_date'];
        array_key_exists('update_date', $data) && $this->container['update_date'] = $data['update_date'];
    ...
    public function listInvalidUnrequiredProperties()
    {
        ...
        if (
            array_key_exists('status', $this->container)
        ...
        if (
            array_key_exists('public_note', $this->container)
            && $this->container['public_note'] !== null
            && (strlen($this->container['public_note']) > 3500)
        ) {
        ...
        if (
            array_key_exists('public_note', $this->container)
            && $this->container['public_note'] !== null
            && (strlen($this->container['public_note']) < 1)
        ) {
...
null;
    ...
    {
        return array_key_exists('status', $this->container) ? $this->container['status'] :
null;
    }
...
null;
     ...
     * Sets id_version
     *
     * @param string $id_version Active version ID between the available in the program platform
     *
     * @return $this
     */
    ...
    {
        return array_key_exists('publish_date', $this->container) ? $this->container['publish_date'] :
null;
    }
     ...
     * Sets publish_date
     *
     * @param \DateTime $publish_date Program publication date in the language
     *
     * @return $this
     */
    ...
    {
        return array_key_exists('update_date', $this->container) ? $this->container['update_date'] :
null;
    }
     ...
     * Sets update_date
     *
     * @param \DateTime $update_date Last update date
     *
     * @return $this
     */
    ...
    {
        return array_key_exists('public_note', $this->container) ? $this->container['public_note'] :
null;
    }
