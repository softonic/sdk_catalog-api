...
/**
 * ProgramPlatformLanguageAlias Class Doc Comment
 *
 * @category Class
 * @description Program platform language alias model
 * @package  Softonic\CatalogApiSdk
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProgramPlatformLanguageAlias implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProgramPlatformLanguageAlias';
...
'id_alias' => 'getIdAlias'    ];
    ...
    public function listInvalidUnrequiredProperties()
    {
        $invalidProperties = [];
        if (
            array_key_exists('id_alias', $this->container)
            && $this->container['id_alias'] !== null
            && (strlen($this->container['id_alias']) > 60)
        ) {
        ...
        if (
            array_key_exists('id_alias', $this->container)
            && $this->container['id_alias'] !== null
            && (strlen($this->container['id_alias']) < 1)
        ) {
...
null;
    ...
    {
        return array_key_exists('id_alias', $this->container) ? $this->container['id_alias'] :
null;
    }
