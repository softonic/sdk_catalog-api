...
class ProgramVersion implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^[A-Za-z0-9.-]{1,60}$/", $this->container['id_version'])) {
            $invalid_properties[] = "invalid value for 'id_version', must be conform to the pattern /^[A-Za-z0-9.-]{1,60}$/.";
        }
        ...
        if (!is_null($this->container['age']) && ($this->container['age'] > 22)) {
            $invalid_properties[] = "invalid value for 'age', must be smaller than or equal to 22.";
        }
