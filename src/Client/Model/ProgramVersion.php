...
class ProgramVersion implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    public function __construct(array $data = [])
    {
        ...
        if (array_key_exists('preversion', $data)) $this->container['preversion'] = $data['preversion'];
        if (array_key_exists('postversion', $data)) $this->container['postversion'] = $data['postversion'];
        if (array_key_exists('supported_formats', $data)) $this->container['supported_formats'] = $data['supported_formats'];
        if (array_key_exists('id_license', $data)) $this->container['id_license'] = $data['id_license'];
        if (array_key_exists('age', $data)) $this->container['age'] = $data['age'];
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (array_key_exists('preversion', $this->container) && !is_null($this->container['preversion']) && (strlen($this->container['preversion']) > 255)) {
            $invalidProperties[] = "invalid value for 'preversion', the character length must be smaller than or equal to 255.";
        }

        if (array_key_exists('preversion', $this->container) && !is_null($this->container['preversion']) && (strlen($this->container['preversion']) < 1)) {
            $invalidProperties[] = "invalid value for 'preversion', the character length must be bigger than or equal to 1.";
        }

        if (array_key_exists('postversion', $this->container) && !is_null($this->container['postversion']) && (strlen($this->container['postversion']) > 255)) {
            $invalidProperties[] = "invalid value for 'postversion', the character length must be smaller than or equal to 255.";
        }

        if (array_key_exists('postversion', $this->container) && !is_null($this->container['postversion']) && (strlen($this->container['postversion']) < 1)) {
            $invalidProperties[] = "invalid value for 'postversion', the character length must be bigger than or equal to 1.";
        }

        if (array_key_exists('supported_formats', $this->container) && !is_null($this->container['supported_formats']) && (strlen($this->container['supported_formats']) > 1340)) {
            $invalidProperties[] = "invalid value for 'supported_formats', the character length must be smaller than or equal to 1340.";
        }

        if (array_key_exists('supported_formats', $this->container) && !is_null($this->container['supported_formats']) && (strlen($this->container['supported_formats']) < 1)) {
            $invalidProperties[] = "invalid value for 'supported_formats', the character length must be bigger than or equal to 1.";
        }

        if (array_key_exists('id_license', $this->container) && !is_null($this->container['id_license']) && (strlen($this->container['id_license']) > 3)) {
            $invalidProperties[] = "invalid value for 'id_license', the character length must be smaller than or equal to 3.";
        }

        if (array_key_exists('id_license', $this->container) && !is_null($this->container['id_license']) && (strlen($this->container['id_license']) < 1)) {
            $invalidProperties[] = "invalid value for 'id_license', the character length must be bigger than or equal to 1.";
        }

        if (array_key_exists('age', $this->container) && !is_null($this->container['age']) && ($this->container['age'] > 22)) {
            $invalidProperties[] = "invalid value for 'age', must be smaller than or equal to 22.";
        }

        if (array_key_exists('age', $this->container) && !is_null($this->container['age']) && ($this->container['age'] < 0)) {
