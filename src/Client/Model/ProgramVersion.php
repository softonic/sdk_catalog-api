...
class ProgramVersion implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['age']) && ($this->container['age'] > 22.0)) {
            $invalid_properties[] = "invalid value for 'age', must be smaller than or equal to 22.0.";
        }
    ...
    {
        if (!is_null($id_minimum_requirements_group) && (strlen($id_minimum_requirements_group) > 36)) {
    ...
    {
        if (!is_null($id_recommended_requirements_group) && (strlen($id_recommended_requirements_group) > 36)) {
    ...
    {
        if (!is_null($supported_formats) && (strlen($supported_formats) > 1024)) {
    ...
    public function setAge($age)
    {
        ...
        if (!is_null($age) && ($age > 22.0)) {
            throw new \InvalidArgumentException('invalid value for $age when calling ProgramVersion., must be smaller than or equal to 22.0.');
        }
        if (!is_null($age) && ($age < 0.0)) {
