...
class ProgramVersion implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['supported_formats']) && (strlen($this->container['supported_formats']) > 1340)) {
            $invalid_properties[] = "invalid value for 'supported_formats', the character length must be smaller than or equal to 1340.";
        }
    ...
    public function valid()
    {
        ...
        if (strlen($this->container['supported_formats']) > 1340) {
            return false;
        }
