...
class Program implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['id_appstore']) && (strlen($this->container['id_appstore']) > 255)) {
            $invalidProperties[] = "invalid value for 'id_appstore', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['id_appstore']) && (strlen($this->container['id_appstore']) < 1)) {
            $invalidProperties[] = "invalid value for 'id_appstore', the character length must be bigger than or equal to 1.";
        }
