...
class Program implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    public function __construct(array $data = [])
    {
        ...
        if (array_key_exists('google_compliant', $data)) $this->container['google_compliant'] = $data['google_compliant'];
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (array_key_exists('id_developer', $this->container) && !is_null($this->container['id_developer']) && !preg_match("/^[0-9a-zA-Z](?!.*[\\-]{2})([0-9a-zA-Z\\-]{0,98}[0-9a-zA-Z])?$/", $this->container['id_developer'])) {
