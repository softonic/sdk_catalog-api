 ...
 *
 * @category Class
 * @description Platform version model
 * @package  Softonic\CatalogApiSdk
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PlatformVersion implements ModelInterface, ArrayAccess, JsonSerializable
{
...
'name' => 'getName'    ];
    ...
    public function listInvalidUnrequiredProperties()
    {
        $invalidProperties = [];
        if (
            array_key_exists('id_platform', $this->container)
            && $this->container['id_platform'] !== null
            && (strlen($this->container['id_platform']) > 20)
        ) {
        ...
        if (
            array_key_exists('id_platform', $this->container)
            && $this->container['id_platform'] !== null
            && (strlen($this->container['id_platform']) < 1)
        ) {
        ...
        if (
            ...
            && (strlen($this->container['id_version']) > 40)
        ) {
            $invalidProperties[] = "invalid value for 'id_version', the character length must be smaller than or equal to 40.";
        }
