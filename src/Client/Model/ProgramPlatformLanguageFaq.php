...
'priority' => 'getPriority'    ];
    ...
    public function listInvalidUnrequiredProperties()
    {
        $invalidProperties = [];
        if (
            array_key_exists('question', $this->container)
            && $this->container['question'] !== null
            && (strlen($this->container['question']) > 500)
        ) {
            $invalidProperties[] = "invalid value for 'question', the character length must be smaller than or equal to 500.";
        }

        if (
            array_key_exists('question', $this->container)
            && $this->container['question'] !== null
            && (strlen($this->container['question']) < 1)
        ) {
            $invalidProperties[] = "invalid value for 'question', the character length must be bigger than or equal to 1.";
        }

        if (
            array_key_exists('answer', $this->container)
            && $this->container['answer'] !== null
            && (strlen($this->container['answer']) > 3000)
        ) {
            $invalidProperties[] = "invalid value for 'answer', the character length must be smaller than or equal to 3000.";
        }

        if (
            array_key_exists('answer', $this->container)
            && $this->container['answer'] !== null
            && (strlen($this->container['answer']) < 1)
        ) {
...
null;
    ...
    {
        return array_key_exists('id_faq', $this->container) ? $this->container['id_faq'] :
null;
    }
    ...
    {
        return array_key_exists('question', $this->container) ? $this->container['question'] :
null;
    }
    ...
    {
        return array_key_exists('answer', $this->container) ? $this->container['answer'] :
null;
    }
