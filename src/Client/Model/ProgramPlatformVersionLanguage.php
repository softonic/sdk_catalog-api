...
/**
 * ProgramPlatformVersionLanguage Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProgramPlatformVersionLanguage implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProgramPlatformVersionLanguage';
...
'about_license' => 'getAboutLicense'    ];
    ...
    public function __construct(array $data = [])
    {
        ...
        array_key_exists('program_name', $data) && $this->container['program_name'] = $data['program_name'];
        array_key_exists('visible', $data) && $this->container['visible'] = $data['visible'];
        array_key_exists('about_license', $data) && $this->container['about_license'] = $data['about_license'];
    }
    ...
    public function listInvalidUnrequiredProperties()
    {
        $invalidProperties = [];
        if (
            array_key_exists('program_name', $this->container)
            && $this->container['program_name'] !== null
            && (strlen($this->container['program_name']) > 130)
        ) {
        ...
        if (
            array_key_exists('program_name', $this->container)
            && $this->container['program_name'] !== null
            && (strlen($this->container['program_name']) < 1)
        ) {
            $invalidProperties[] = "invalid value for 'program_name', the character length must be bigger than or equal to 1.";
        }

        if (
            array_key_exists('about_license', $this->container)
            && $this->container['about_license'] !== null
            && (strlen($this->container['about_license']) > 1200)
        ) {
        ...
        if (
            array_key_exists('about_license', $this->container)
            && $this->container['about_license'] !== null
            && (strlen($this->container['about_license']) < 1)
        ) {
...
null;
    ...
    {
        return array_key_exists('program_name', $this->container) ? $this->container['program_name'] :
null;
    }
    ...
    {
        return array_key_exists('visible', $this->container) ? $this->container['visible'] :
null;
    }
     ...
     * Sets visible
     *
     * @param bool $visible Is version visible for this language?
     *
     * @return $this
     */
    ...
    {
        return array_key_exists('about_license', $this->container) ? $this->container['about_license'] :
null;
    }
     ...
     * Sets about_license
     *
     * @param string $about_license License extra information
     *
     * @return $this
     */
