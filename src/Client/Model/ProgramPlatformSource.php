...
'id_store' => 'getIdStore'    ];
    ...
    public function listInvalidUnrequiredProperties()
    {
        $invalidProperties = [];
        if (
            array_key_exists('id_store', $this->container)
            && $this->container['id_store'] !== null
            && (strlen($this->container['id_store']) > 255)
        ) {
        ...
        if (
            array_key_exists('id_store', $this->container)
            && $this->container['id_store'] !== null
            && (strlen($this->container['id_store']) < 1)
        ) {
...
null;
    ...
    {
        return array_key_exists('id_source', $this->container) ? $this->container['id_source'] :
null;
    }
    ...
    {
        return array_key_exists('id_store', $this->container) ? $this->container['id_store'] :
null;
    }
     ...
     * Sets id_store
     *
     * @param string $id_store Store ID
     *
     * @return $this
     */
