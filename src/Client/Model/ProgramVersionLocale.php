...
class ProgramVersionLocale implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^(?!.*[\\-]{2})[0-9a-z\\-]{0,60}[0-9a-z]+$/", $this->container['program_alias'])) {
            $invalid_properties[] = "invalid value for 'program_alias', must be conform to the pattern /^(?!.*[\\-]{2})[0-9a-z\\-]{0,60}[0-9a-z]+$/.";
        }
    ...
    public function setProgramAlias($program_alias)
    {
        ...
        if ((!preg_match("/^(?!.*[\\-]{2})[0-9a-z\\-]{0,60}[0-9a-z]+$/", $program_alias))) {
            throw new \InvalidArgumentException("invalid value for $program_alias when calling ProgramVersionLocale., must conform to the pattern /^(?!.*[\\-]{2})[0-9a-z\\-]{0,60}[0-9a-z]+$/.");
        }
