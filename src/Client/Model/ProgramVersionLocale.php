...
class ProgramVersionLocale implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['id_editor']) && ($this->container['id_editor'] < 0.0)) {
            $invalid_properties[] = "invalid value for 'id_editor', must be bigger than or equal to 0.0.";
        }
    ...
    public function valid()
    {
        ...
        if ($this->container['id_editor'] < 0.0) {
            return false;
        }
    ...
    public function setIdEditor($id_editor)
    {
        ...
        if (!is_null($id_editor) && ($id_editor < 0.0)) {
            throw new \InvalidArgumentException('invalid value for $id_editor when calling ProgramVersionLocale., must be bigger than or equal to 0.0.');
        }
