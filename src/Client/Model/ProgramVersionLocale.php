...
class ProgramVersionLocale implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    public function __construct(array $data = [])
    {
        ...
        array_key_exists('revision_date', $data) && $this->container['revision_date'] = $data['revision_date'];
    ...
    {
        return array_key_exists('active', $this->container) ? $this->container['active'] : null;
    }
