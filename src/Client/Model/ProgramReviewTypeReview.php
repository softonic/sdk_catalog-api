...
class ProgramReviewTypeReview implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['rating']) && ($this->container['rating'] > 10.0)) {
            $invalid_properties[] = "invalid value for 'rating', must be smaller than or equal to 10.0.";
        }

        if (!is_null($this->container['rating']) && ($this->container['rating'] < 0.0)) {
