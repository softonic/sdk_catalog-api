 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProgramPlatformLocaleAlias implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^[a-z0-9-]{1,60}$/", $this->container['id_alias'])) {
            $invalidProperties[] = "invalid value for 'id_alias', must be conform to the pattern /^[a-z0-9-]{1,60}$/.";
        }
    ...
    public function setIdAlias($id_alias)
    {
        ...
        if ((!preg_match("/^[a-z0-9-]{1,60}$/", $id_alias))) {
            throw new \InvalidArgumentException("invalid value for $id_alias when calling ProgramPlatformLocaleAlias., must conform to the pattern /^[a-z0-9-]{1,60}$/.");
        }
