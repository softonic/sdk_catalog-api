...
class ProgramPlatformLocaleAlias implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^[a-z0-9](?:[a-z0-9\\-_\\.]{0,250}[a-z0-9])(?:[\\-_])?$/", $this->container['id_alias'])) {
            $invalidProperties[] = "invalid value for 'id_alias', must be conform to the pattern /^[a-z0-9](?:[a-z0-9\\-_\\.]{0,250}[a-z0-9])(?:[\\-_])?$/.";
        }
    ...
    public function validProperties()
    {
        ...
        if (array_key_exists('id_alias', $this->container) && !preg_match("/^[a-z0-9](?:[a-z0-9\\-_\\.]{0,250}[a-z0-9])(?:[\\-_])?$/", $this->container['id_alias'])) {
            return false;
        }
        return true;
    }
    ...
    public function setIdAlias($id_alias)
    {
        ...
        if ((!preg_match("/^[a-z0-9](?:[a-z0-9\\-_\\.]{0,250}[a-z0-9])(?:[\\-_])?$/", $id_alias))) {
            throw new \InvalidArgumentException("invalid value for $id_alias when calling ProgramPlatformLocaleAlias., must conform to the pattern /^[a-z0-9](?:[a-z0-9\\-_\\.]{0,250}[a-z0-9])(?:[\\-_])?$/.");
        }
