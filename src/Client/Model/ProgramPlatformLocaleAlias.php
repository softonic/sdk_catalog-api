...
class ProgramPlatformLocaleAlias implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^[0-9a-z][0-9a-z\\-]{0,59}$/", $this->container['id_alias'])) {
            $invalidProperties[] = "invalid value for 'id_alias', must be conform to the pattern /^[0-9a-z][0-9a-z\\-]{0,59}$/.";
        }
    ...
    public function setIdAlias($id_alias)
    {
        ...
        if ((!preg_match("/^[0-9a-z][0-9a-z\\-]{0,59}$/", $id_alias))) {
            throw new \InvalidArgumentException("invalid value for $id_alias when calling ProgramPlatformLocaleAlias., must conform to the pattern /^[0-9a-z][0-9a-z\\-]{0,59}$/.");
        }
