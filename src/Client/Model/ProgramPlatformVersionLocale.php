...
/**
 * ProgramPlatformVersionLocale Class Doc Comment
 *
 * @category Class
 * @description Program platform version locale model
 * @package  Softonic\CatalogApiSdk
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProgramPlatformVersionLocale implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProgramPlatformVersionLocale';
...
'id_locale' => 'getIdLocale'    ];
    ...
    const ID_LOCALE_EN_GB = 'en-GB';
const ID_LOCALE_ES_ES = 'es-ES';
const ID_LOCALE_DE_DE = 'de-DE';
const ID_LOCALE_FR_FR = 'fr-FR';
const ID_LOCALE_IT_IT = 'it-IT';
const ID_LOCALE_RU_RU = 'ru-RU';
const ID_LOCALE_PT_BR = 'pt-BR';
const ID_LOCALE_NL_NL = 'nl-NL';
const ID_LOCALE_PL_PL = 'pl-PL';
const ID_LOCALE_PT_PT = 'pt-PT';
const ID_LOCALE_ZH_CN = 'zh-CN';
const ID_LOCALE_TR_TR = 'tr-TR';
const ID_LOCALE_AR_SA = 'ar-SA';
const ID_LOCALE_CS_CZ = 'cs-CZ';
const ID_LOCALE_KO_KR = 'ko-KR';
const ID_LOCALE_EL_GR = 'el-GR';
const ID_LOCALE_HI_IN = 'hi-IN';
const ID_LOCALE_JA_JP = 'ja-JP';
const ID_LOCALE_DA_DK = 'da-DK';
const ID_LOCALE_FI_FI = 'fi-FI';
const ID_LOCALE_NO_NO = 'no-NO';
const ID_LOCALE_SV_SE = 'sv-SE';
    ...
    {
        return [
            self::ID_LOCALE_EN_GB,
self::ID_LOCALE_ES_ES,
self::ID_LOCALE_DE_DE,
self::ID_LOCALE_FR_FR,
self::ID_LOCALE_IT_IT,
self::ID_LOCALE_RU_RU,
self::ID_LOCALE_PT_BR,
self::ID_LOCALE_NL_NL,
self::ID_LOCALE_PL_PL,
self::ID_LOCALE_PT_PT,
self::ID_LOCALE_ZH_CN,
self::ID_LOCALE_TR_TR,
self::ID_LOCALE_AR_SA,
self::ID_LOCALE_CS_CZ,
self::ID_LOCALE_KO_KR,
self::ID_LOCALE_EL_GR,
self::ID_LOCALE_HI_IN,
self::ID_LOCALE_JA_JP,
self::ID_LOCALE_DA_DK,
self::ID_LOCALE_FI_FI,
self::ID_LOCALE_NO_NO,
self::ID_LOCALE_SV_SE,        ];
    }
    ...
    public function listInvalidUnrequiredProperties()
    {
        ...
        if (
            array_key_exists('id_locale', $this->container)
            && $this->container['id_locale'] !== null
            && !in_array($this->container['id_locale'], $allowedValues, true)
        ) {
...
null;
    ...
    {
        return array_key_exists('id_locale', $this->container) ? $this->container['id_locale'] :
null;
    }
     ...
     * Sets id_locale
     *
     * @param string $id_locale Locale ID
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getIdLocaleAllowableValues();
        if (!is_null($id_locale) && !in_array($id_locale, $allowedValues, true)) {
