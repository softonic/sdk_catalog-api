...
/**
 * ProgramPlatformReviewtype Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProgramPlatformReviewtype implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProgramPlatformReviewtype';
...
'id_reviewtype' => 'getIdReviewtype'    ];
    ...
    const ID_REVIEWTYPE_CORPORATE = 'corporate';
const ID_REVIEWTYPE_DEVELOPER = 'developer';
    ...
    {
        return [
            self::ID_REVIEWTYPE_CORPORATE,
self::ID_REVIEWTYPE_DEVELOPER,        ];
    }
    ...
    public function listInvalidUnrequiredProperties()
    {
        ...
        if (
            array_key_exists('id_reviewtype', $this->container)
            && $this->container['id_reviewtype'] !== null
            && !in_array($this->container['id_reviewtype'], $allowedValues, true)
        ) {
            $invalidProperties[] = sprintf(
                "invalid value for 'id_reviewtype', must be one of '%s'",
...
null;
    ...
    {
        $allowedValues = $this->getIdReviewtypeAllowableValues();
        if (!is_null($id_reviewtype) && !in_array($id_reviewtype, $allowedValues, true)) {
