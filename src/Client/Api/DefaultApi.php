...
class DefaultApi
{
     ...
     * @return void
     */
    public function schemaGet()
    {
        $this->schemaGetWithHttpInfo();
    }
     ...
     */
    public function schemaGetWithHttpInfo()
    {
        $returnType = '';
        $request = $this->schemaGetRequest();
     ...
     */
    public function schemaGetAsync()
    {
        return $this->schemaGetAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function schemaGetAsyncWithHttpInfo()
    {
        $returnType = '';
        $request = $this->schemaGetRequest();
     ...
     */
    protected function schemaGetRequest()
    {
