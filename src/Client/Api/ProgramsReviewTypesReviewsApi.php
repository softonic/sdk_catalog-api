...
class ProgramsReviewTypesReviewsApi
{
     ...
     * @param \Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Client\Model\ProgramReviewTypeReview $body  (optional)
     ...
     * @param string $id_review_type Review owner type (required)
     * @throws \Softonic\CatalogApiSdk\ApiException on non-2xx response
     * @return \Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Client\Model\ProgramReviewTypeReview[]
     */
     ...
     * @param string $id_review_type Review owner type (required)
     * @throws \Softonic\CatalogApiSdk\ApiException on non-2xx response
     * @return array of \Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Client\Model\ProgramReviewTypeReview[], HTTP status code, HTTP response headers (array of strings)
     */
    public function findProgramReviewTypeReviewWithHttpInfo($id_program, $id_review_type)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Client\Model\ProgramReviewTypeReview[]',
                '/programs/{id_program}/review-types/{id_review_type}/reviews'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Client\Model\ProgramReviewTypeReview[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Client\Model\ProgramReviewTypeReview[]', $e->getResponseHeaders());
