...
class PlatformsVersionsApi
{
     ...
     * @param  string $id_platform Platform ID (required)
     * @param  string $id_version Platform version ID (required)
     * @param  \Softonic\CatalogApiSdk\Client\Model\PlatformVersion $body body (optional)
     *
     * @throws \Softonic\CatalogApiSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
    ...
    {
        $this->replacePlatformVersionWithHttpInfo($id_platform, $id_version, $body);
    }
     ...
     * @param  string $id_platform Platform ID (required)
     * @param  string $id_version Platform version ID (required)
     * @param  \Softonic\CatalogApiSdk\Client\Model\PlatformVersion $body (optional)
     *
     * @throws \Softonic\CatalogApiSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    {
        $returnType = '';
        $request = $this->replacePlatformVersionRequest($id_platform, $id_version, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function replacePlatformVersionAsync($id_platform, $id_version, $body = null)
    {
        return $this->replacePlatformVersionAsyncWithHttpInfo($id_platform, $id_version, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function replacePlatformVersionAsyncWithHttpInfo($id_platform, $id_version, $body = null)
    {
        $returnType = '';
        $request = $this->replacePlatformVersionRequest($id_platform, $id_version, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function replacePlatformVersionRequest($id_platform, $id_version, $body = null)
    {
        // verify the required parameter 'id_platform' is set
        if ($id_platform === null) {
            throw new \InvalidArgumentException(
        ...
        if (strlen($id_platform) > 20) {
            throw new \InvalidArgumentException('invalid length for "$id_platform" when calling PlatformsVersionsApi.replacePlatformVersion, must be smaller than or equal to 20.');
        }
        if (strlen($id_platform) < 1) {
            throw new \InvalidArgumentException('invalid length for "$id_platform" when calling PlatformsVersionsApi.replacePlatformVersion, must be bigger than or equal to 1.');
        }
        ...
        if (strlen($id_version) > 40) {
            throw new \InvalidArgumentException('invalid length for "$id_version" when calling PlatformsVersionsApi.replacePlatformVersion, must be smaller than or equal to 40.');
        }
        if (strlen($id_version) < 1) {
            throw new \InvalidArgumentException('invalid length for "$id_version" when calling PlatformsVersionsApi.replacePlatformVersion, must be bigger than or equal to 1.');
        }
