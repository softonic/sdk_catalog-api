...
class ProgramsUrlTypesUrlsApi
{
     ...
     * @param \Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Client\Model\ProgramUrlTypeUrl $body  (optional)
     ...
     * @param string $id_url_type URL types identifier. (required)
     * @throws \Softonic\CatalogApiSdk\ApiException on non-2xx response
     * @return \Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Client\Model\ProgramUrlTypeUrl[]
     */
     ...
     * @param string $id_url_type URL types identifier. (required)
     * @throws \Softonic\CatalogApiSdk\ApiException on non-2xx response
     * @return array of \Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Client\Model\ProgramUrlTypeUrl[], HTTP status code, HTTP response headers (array of strings)
     */
    public function findProgramUrlTypeUrlWithHttpInfo($id_program, $id_url_type)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Client\Model\ProgramUrlTypeUrl[]',
                '/programs/{id_program}/url-types/{id_url_type}/urls'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Client\Model\ProgramUrlTypeUrl[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Client\Model\ProgramUrlTypeUrl[]', $e->getResponseHeaders());
