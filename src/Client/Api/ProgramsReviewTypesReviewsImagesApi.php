...
class ProgramsReviewTypesReviewsImagesApi
{
     ...
     * @return void
     */
    public function createProgramReviewTypeReviewImage($id_program, $id_review_type, $id_review, $id_image, $body = null)
    {
        list($response) = $this->createProgramReviewTypeReviewImageWithHttpInfo($id_program, $id_review_type, $id_review, $id_image, $body);
        return $response;
    }
     ...
     */
    public function createProgramReviewTypeReviewImageWithHttpInfo($id_program, $id_review_type, $id_review, $id_image, $body = null)
    {
        ...
        if ($id_image === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id_image when calling createProgramReviewTypeReviewImage');
        }
        if ((strlen($id_image) > 40)) {
            throw new \InvalidArgumentException('invalid length for "$id_image" when calling ProgramsReviewTypesReviewsImagesApi.createProgramReviewTypeReviewImage, must be smaller than or equal to 40.');
        }
        if ((strlen($id_image) < 40)) {
            throw new \InvalidArgumentException('invalid length for "$id_image" when calling ProgramsReviewTypesReviewsImagesApi.createProgramReviewTypeReviewImage, must be bigger than or equal to 40.');
        }
