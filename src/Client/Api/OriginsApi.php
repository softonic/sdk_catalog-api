...
class OriginsApi
{
     ...
     * @return \Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Client\Model\Origin[]
     */
     ...
     *
     * @throws \Softonic\CatalogApiSdk\ApiException on non-2xx response
     * @return array of \Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Client\Model\Origin[], HTTP status code, HTTP response headers (array of strings)
     */
    public function findOriginWithHttpInfo()
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Client\Model\Origin[]',
                '/origins'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Client\Model\Origin[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Client\Model\Origin[]', $e->getResponseHeaders());
     ...
     *
     * @param string $id_origin Origin ID (required)
     * @param \Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Client\Model\Origin $body  (optional)
     * @throws \Softonic\CatalogApiSdk\ApiException on non-2xx response
     * @return void
     */
