...
class ProgramsVersionsLanguagesApi
{
     ...
     * @param \Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Client\Model\ProgramVersionLanguage $body  (optional)
     ...
     * @param string $id_version Program version identifier (required)
     * @throws \Softonic\CatalogApiSdk\ApiException on non-2xx response
     * @return \Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Client\Model\ProgramVersionLanguage[]
     */
     ...
     * @param string $id_version Program version identifier (required)
     * @throws \Softonic\CatalogApiSdk\ApiException on non-2xx response
     * @return array of \Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Client\Model\ProgramVersionLanguage[], HTTP status code, HTTP response headers (array of strings)
     */
    public function findProgramVersionLanguageWithHttpInfo($id_program, $id_version)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Client\Model\ProgramVersionLanguage[]',
                '/programs/{id_program}/versions/{id_version}/languages'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Client\Model\ProgramVersionLanguage[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Client\Model\ProgramVersionLanguage[]', $e->getResponseHeaders());
