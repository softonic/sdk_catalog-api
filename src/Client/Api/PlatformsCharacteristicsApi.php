...
class PlatformsCharacteristicsApi
{
     ...
     * @return \Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Client\Model\PlatformCharacteristic[]
     */
     ...
     * @param string $id_platform Platform ID (required)
     * @throws \Softonic\CatalogApiSdk\ApiException on non-2xx response
     * @return array of \Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Client\Model\PlatformCharacteristic[], HTTP status code, HTTP response headers (array of strings)
     */
    public function findPlatformCharacteristicWithHttpInfo($id_platform)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Client\Model\PlatformCharacteristic[]',
                '/platforms/{id_platform}/characteristics'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Client\Model\PlatformCharacteristic[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Client\Model\PlatformCharacteristic[]', $e->getResponseHeaders());
