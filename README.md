...
- API version: 2.0.88-841
- Build date: 2016-07-14T08:30:12.515Z
...
*ProgramsVersionsLocalesImagesApi* | [**createProgramVersionLocaleImage**](docs/Api/ProgramsVersionsLocalesImagesApi.md#createprogramversionlocaleimage) | **POST** /programs/{id_program}/versions/{id_version}/locales/{id_locale}/images | Creates a new ProgramVersionLocaleImage
*ProgramsVersionsLocalesImagesApi* | [**deleteProgramVersionLocaleImage**](docs/Api/ProgramsVersionsLocalesImagesApi.md#deleteprogramversionlocaleimage) | **DELETE** /programs/{id_program}/versions/{id_version}/locales/{id_locale}/images/{id_image} | Deletes a ProgramVersionLocaleImage
*ProgramsVersionsLocalesImagesApi* | [**findProgramVersionLocaleImage**](docs/Api/ProgramsVersionsLocalesImagesApi.md#findprogramversionlocaleimage) | **GET** /programs/{id_program}/versions/{id_version}/locales/{id_locale}/images | List of ProgramVersionLocaleImages
*ProgramsVersionsLocalesImagesApi* | [**readProgramVersionLocaleImage**](docs/Api/ProgramsVersionsLocalesImagesApi.md#readprogramversionlocaleimage) | **GET** /programs/{id_program}/versions/{id_version}/locales/{id_locale}/images/{id_image} | Fetches a single ProgramVersionLocaleImage
*ProgramsVersionsLocalesImagesApi* | [**replaceProgramVersionLocaleImage**](docs/Api/ProgramsVersionsLocalesImagesApi.md#replaceprogramversionlocaleimage) | **PUT** /programs/{id_program}/versions/{id_version}/locales/{id_locale}/images/{id_image} | Entirely replaces a ProgramVersionLocaleImage
*ProgramsVersionsLocalesImagesApi* | [**updateProgramVersionLocaleImage**](docs/Api/ProgramsVersionsLocalesImagesApi.md#updateprogramversionlocaleimage) | **PATCH** /programs/{id_program}/versions/{id_version}/locales/{id_locale}/images/{id_image} | Partially updates a ProgramVersionLocaleImage
...
## Documentation For Models
 ...
 - [ProgramVersionLocaleImage](docs/Model/ProgramVersionLocaleImage.md)
...
- **Scopes**: 
 ...
 - **catalog_api.read.programs.versions.locales.images**: Read Programs/Versions/Locales/Images
 - **catalog_api.delete.programs.versions.locales.images**: Delete Programs/Versions/Locales/Images
 - **catalog_api.replace.programs.versions.locales.images**: Replace Programs/Versions/Locales/Images
 - **catalog_api.update.programs.versions.locales.images**: Update Programs/Versions/Locales/Images
 - **catalog_api.find.programs.versions.locales.images**: Find Programs/Versions/Locales/Images
 - **catalog_api.create.programs.versions.locales.images**: Create Programs/Versions/Locales/Images
