...
*OriginsApi* | [**replaceOrigin**](docs/Api/OriginsApi.md#replaceorigin) | **PUT** /origins/{id_origin} | Entirely replaces a Origin
...
*ProgramsPlatformsLocalesAliasesApi* | [**deleteProgramPlatformLocaleAlias**](docs/Api/ProgramsPlatformsLocalesAliasesApi.md#deleteprogramplatformlocalealias) | **DELETE** /programs/{id_program}/platforms/{id_platform}/locales/{id_locale}/aliases/{id_alias} | Deletes a ProgramPlatformLocaleAlias
*ProgramsPlatformsLocalesAliasesApi* | [**findProgramPlatformLocaleAlias**](docs/Api/ProgramsPlatformsLocalesAliasesApi.md#findprogramplatformlocalealias) | **GET** /programs/{id_program}/platforms/{id_platform}/locales/{id_locale}/aliases | List of ProgramPlatformLocaleAliass
*ProgramsPlatformsLocalesAliasesApi* | [**replaceProgramPlatformLocaleAlias**](docs/Api/ProgramsPlatformsLocalesAliasesApi.md#replaceprogramplatformlocalealias) | **PUT** /programs/{id_program}/platforms/{id_platform}/locales/{id_locale}/aliases/{id_alias} | Entirely replaces a ProgramPlatformLocaleAlias
*ProgramsPlatformsSourcesApi* | [**createProgramPlatformSource**](docs/Api/ProgramsPlatformsSourcesApi.md#createprogramplatformsource) | **POST** /programs/{id_program}/platforms/{id_platform}/sources | Creates a new ProgramPlatformSource
...
*ProgramsPlatformsSourcesApi* | [**findProgramPlatformSource**](docs/Api/ProgramsPlatformsSourcesApi.md#findprogramplatformsource) | **GET** /programs/{id_program}/platforms/{id_platform}/sources | List of ProgramPlatformSources
...
*SourcesApi* | [**createSource**](docs/Api/SourcesApi.md#createsource) | **POST** /sources | Creates a new Source
*SourcesApi* | [**deleteSource**](docs/Api/SourcesApi.md#deletesource) | **DELETE** /sources/{id_source} | Deletes a Source
*SourcesApi* | [**findSource**](docs/Api/SourcesApi.md#findsource) | **GET** /sources | List of Sources
...
## Documentation For Models
 ...
 - [ProgramPlatformLocaleAlias](docs/Model/ProgramPlatformLocaleAlias.md)
...
- **Scopes**: 
 ...
 - **catalog_api.read.sources**: Read Sources
 - **catalog_api.delete.sources**: Delete Sources
 - **catalog_api.replace.sources**: Replace Sources
 - **catalog_api.update.sources**: Update Sources
 - **catalog_api.find.sources**: Find Sources
 - **catalog_api.create.sources**: Create Sources
 - **catalog_api.read.platforms.characteristics**: Read Platforms/Characteristics
 - **catalog_api.replace.platforms.characteristics**: Replace Platforms/Characteristics
 ...
 - **catalog_api.replace.platforms.versions**: Replace Platforms/Versions
 ...
 - **catalog_api.read.programs.platforms.sources**: Read Programs/Platforms/Sources
 - **catalog_api.delete.programs.platforms.sources**: Delete Programs/Platforms/Sources
 - **catalog_api.replace.programs.platforms.sources**: Replace Programs/Platforms/Sources
 - **catalog_api.update.programs.platforms.sources**: Update Programs/Platforms/Sources
 - **catalog_api.find.programs.platforms.sources**: Find Programs/Platforms/Sources
 - **catalog_api.create.programs.platforms.sources**: Create Programs/Platforms/Sources
 - **catalog_api.delete.programs.platforms.locales.aliases**: Delete Programs/Platforms/Locales/Aliases
 - **catalog_api.replace.programs.platforms.locales.aliases**: Replace Programs/Platforms/Locales/Aliases
 - **catalog_api.find.programs.platforms.locales.aliases**: Find Programs/Platforms/Locales/Aliases
