...
class ProgramsPlatformsVersionsLanguagesImagesApi
{
        ...
        try {
            ...
            switch ($e->getCode()) {
                ...
                case 409:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\InlineResponse40921',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ProgramPlatformVersionLanguageImage[]
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ProgramPlatformVersionLanguageImage[], HTTP status code, HTTP response headers (array of strings)
     */
    public function findProgramPlatformVersionLanguageImageWithHttpInfo($id_program, $id_platform, $id_version, $id_language)
    {
        $returnType = '\Swagger\Client\Model\ProgramPlatformVersionLanguageImage[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ProgramPlatformVersionLanguageImage[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Swagger\Client\Model\ProgramPlatformVersionLanguageImage $body ProgramPlatformVersionLanguageImage to be updated (required)
     * @param  string $id_program Program ID (required)
     * @param  string $id_platform Platform ID (required)
     * @param  string $id_version Version ID (required)
     * @param  string $id_language Language ID (required)
