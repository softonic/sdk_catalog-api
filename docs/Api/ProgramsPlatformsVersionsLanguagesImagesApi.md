# Swagger\Client\ProgramsPlatformsVersionsLanguagesImagesApi
...
> \Swagger\Client\Model\InlineResponse201 createProgramPlatformVersionLanguageImage($body, $id_program, $id_platform, $id_version, $id_language)
...
$apiInstance = new Swagger\Client\Api\ProgramsPlatformsVersionsLanguagesImagesApi(
...
> \Swagger\Client\Model\InlineResponse2001 deleteProgramPlatformVersionLanguageImage($id_program, $id_platform, $id_version, $id_language, $id_image)
...
> \Swagger\Client\Model\ProgramPlatformVersionLanguageImage[] findProgramPlatformVersionLanguageImage($id_program, $id_platform, $id_version, $id_language)
...
[**\Swagger\Client\Model\ProgramPlatformVersionLanguageImage[]**](../Model/ProgramPlatformVersionLanguageImage.md)
...
> \Swagger\Client\Model\ProgramPlatformVersionLanguageImage readProgramPlatformVersionLanguageImage($id_program, $id_platform, $id_version, $id_language, $id_image)
...
> \Swagger\Client\Model\InlineResponse200 replaceProgramPlatformVersionLanguageImage($body, $id_program, $id_platform, $id_version, $id_language, $id_image)
...
> \Swagger\Client\Model\InlineResponse2002 updateProgramPlatformVersionLanguageImage($body, $id_program, $id_platform, $id_version, $id_language, $id_image)
...
$body = new \Swagger\Client\Model\ProgramPlatformVersionLanguageImage(); // \Swagger\Client\Model\ProgramPlatformVersionLanguageImage | ProgramPlatformVersionLanguageImage to be updated
$id_program = "38400000-8cf0-11bd-b23e-10b96e4ef00d"; // string | Program ID
$id_platform = "id_platform_example"; // string | Platform ID
$id_version = "id_version_example"; // string | Version ID
$id_language = "id_language_example"; // string | Language ID
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\ProgramPlatformVersionLanguageImage**](../Model/ProgramPlatformVersionLanguageImage.md)| ProgramPlatformVersionLanguageImage to be updated |
 **id_program** | [**string**](../Model/.md)| Program ID |
 **id_platform** | **string**| Platform ID |
 **id_version** | **string**| Version ID |
 **id_language** | **string**| Language ID |
