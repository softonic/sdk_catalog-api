...
$api_instance = new Softonic\CatalogApiSdk\Api\ProgramsPlatformsSourcesApi(new \Http\Adapter\Guzzle6\Client());
...
try {
    $api_instance->createProgramPlatformSource($id_program, $id_platform, $body);
} catch (Exception $e) {
...
try {
    $api_instance->deleteProgramPlatformSource($id_program, $id_platform, $id_source);
} catch (Exception $e) {
...
try {
    $result = $api_instance->findProgramPlatformSource($id_program, $id_platform);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $api_instance->readProgramPlatformSource($id_program, $id_platform, $id_source);
    print_r($result);
} catch (Exception $e) {
...
try {
    $api_instance->replaceProgramPlatformSource($id_program, $id_platform, $id_source, $body);
} catch (Exception $e) {
...
try {
    $api_instance->updateProgramPlatformSource($id_program, $id_platform, $id_source, $body);
} catch (Exception $e) {
