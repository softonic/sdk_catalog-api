# Swagger\Client\ProgramsPlatformsVersionsApi
...
> \Swagger\Client\Model\InlineResponse201 createProgramPlatformVersion($body, $id_program, $id_platform)
...
$apiInstance = new Swagger\Client\Api\ProgramsPlatformsVersionsApi(
...
> \Swagger\Client\Model\InlineResponse2001 deleteProgramPlatformVersion($id_program, $id_platform, $id_version)
...
> \Swagger\Client\Model\ProgramPlatformVersion[] findProgramPlatformVersion($id_program, $id_platform)
...
[**\Swagger\Client\Model\ProgramPlatformVersion[]**](../Model/ProgramPlatformVersion.md)
...
> \Swagger\Client\Model\ProgramPlatformVersion readProgramPlatformVersion($id_program, $id_platform, $id_version)
...
> \Swagger\Client\Model\InlineResponse200 replaceProgramPlatformVersion($body, $id_program, $id_platform, $id_version)
...
> \Swagger\Client\Model\InlineResponse2002 updateProgramPlatformVersion($body, $id_program, $id_platform, $id_version)
...
$body = new \Swagger\Client\Model\ProgramPlatformVersion(); // \Swagger\Client\Model\ProgramPlatformVersion | ProgramPlatformVersion to be updated
$id_program = "38400000-8cf0-11bd-b23e-10b96e4ef00d"; // string | Program ID
$id_platform = "id_platform_example"; // string | Platform ID
$id_version = "id_version_example"; // string | Version ID
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\ProgramPlatformVersion**](../Model/ProgramPlatformVersion.md)| ProgramPlatformVersion to be updated |
 **id_program** | [**string**](../Model/.md)| Program ID |
 **id_platform** | **string**| Platform ID |
 **id_version** | **string**| Version ID |
