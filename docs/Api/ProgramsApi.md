...
$body = new \Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Model\Program(); // \Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Model\Program | 
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Model\Program**](../Model/\Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Model\Program.md)|  | [optional]
...
# **findProgram**
> \Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Model\Program[] findProgram($page, $limit, $search)
...
try {
    $result = $api_instance->findProgram($page, $limit, $search);
    print_r($result);
} catch (Exception $e) {
...
[**\Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Model\Program[]**](../Model/Program.md)
...
# **readProgram**
> \Softonic\CatalogApiSdk\Softonic\CatalogApiSdk\Model\Program readProgram($id_program)
